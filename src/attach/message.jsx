  ...
  return(
    <div className="Mainblock4">
        ...
        <button className="btncontact rounded-pill messagebtn4">
          <i class="fa-brands fa-whatsapp text-white messageicon4 rounded contaciconfade"></i>
        </button>
        <button className="btncontact rounded-pill messagebtn5">
          <i class="fa-solid fa-phone text-white messageicon5 rounded contaciconfade"></i>
        </button>
      </div>
  )
}
